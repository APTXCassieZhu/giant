    ...
    <div class="source-box">
        ...
        <Row class="font-footer">
            ...
            <Col span="12" class="footer-col">
                ...
                <Icon size="25" type="md-heart" style="color: red" v-show="favoriteIcon" @click.native="cancelFavorite()"/>
                <Icon size="25" type="md-heart" class="foot-icon1" v-show="!favoriteIcon" @click.native="addFavorite()"/>
            </Col>
        </Row>
    </div>
</template>
